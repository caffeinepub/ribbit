...
export const idlService = IDL.Service({
  ...
  'createPostByPhraseHash' : IDL.Func(
      [
        IDL.Text,
        IDL.Text,
        IDL.Text,
  ...
  'createRibbitByPhraseHash' : IDL.Func(
  ...
  'hasUserLikedPostByPhraseHash' : IDL.Func(
      [IDL.Text, IDL.Text],
      [IDL.Bool],
      ['query'],
    ),
  'hasUserLikedRibbit' : IDL.Func([IDL.Text], [IDL.Bool], ['query']),
  'hasUserLikedRibbitByPhraseHash' : IDL.Func(
      [IDL.Text, IDL.Text],
      [IDL.Bool],
      ['query'],
    ),
  'incrementLilyViewCount' : IDL.Func([IDL.Text], [ViewIncrementResult], []),
  'incrementLilyViewCountByPhraseHash' : IDL.Func(
      [IDL.Text, IDL.Text],
      [ViewIncrementResult],
      [],
    ),
  ...
  'likePostByPhraseHash' : IDL.Func([IDL.Text, IDL.Text], [], []),
  'likeRibbit' : IDL.Func([IDL.Text], [], []),
  'likeRibbitByPhraseHash' : IDL.Func([IDL.Text, IDL.Text], [], []),
  ...
  'unlikePostByPhraseHash' : IDL.Func([IDL.Text, IDL.Text], [], []),
  'unlikeRibbit' : IDL.Func([IDL.Text], [], []),
  'unlikeRibbitByPhraseHash' : IDL.Func([IDL.Text, IDL.Text], [], []),
});
