            ...
            <div className="space-y-0.5">
              {popularTags.map(([tag, count]) => (
                <Link
                  ...
                  to="/tag/$tag"
                  params={{ tag }}
                  className="flex items-center justify-between px-2 py-1.5 rounded-md hover:bg-sidebar-accent transition-colors"
                >
            ...
            <div className="space-y-0.5">
              {popularPosts.map((lily) => (
                <Link
                  ...
                  to="/lily/$id"
                  params={{ id: lily.id }}
                  className="block px-2 py-2 rounded-md hover:bg-sidebar-accent transition-colors"
                >
